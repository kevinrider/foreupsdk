...
print "$course_id : $courses_obj->title : $courses_obj->street : $courses_obj->state : $courses_obj->zip : $courses_obj->course_summary\n";
//exit;
...
$customer_obj->address_1 = "101 Test Way";
$customer_obj->address_2 = "Apt #13";
...
//Entered a Customer
print "$customer_obj->id : $customer_obj->first_name : $customer_obj->last_name : $customer_obj->username : $customer_obj->company_name\n";

//Get One Customer Record
$getone_obj = new Customers();
$getone_obj->getOneCustomer($course_id,$customer_obj->id);
print "GetOne Response: $getone_obj->id : $getone_obj->first_name : $getone_obj->last_name : $getone_obj->username : $getone_obj->company_name\n";
